...
var { useState, useEffect, useLayoutEffect, useDebugValue } = React;
...
var useSyncExternalStore3 = "useSyncExternalStore" in React2 ? ((r) => r.useSyncExternalStore)(React2) : shim;
...
var useIsoMorphicEffect = (effect, deps) => {
  if (env.isServer) {
    (0, import_react4.useEffect)(effect, deps);
  } else {
    (0, import_react4.useLayoutEffect)(effect, deps);
  }
};
...
function handleIOSLocking() {
  ...
  return {
    before() {
      var _a3;
      scrollPosition = (_a3 = window.scrollY) != null ? _a3 : window.pageYOffset;
    },
    after({ doc, d, meta }) {
      ...
      d.microTask(() => {
        ...
        d.add(() => {
          var _a3;
          window.scrollTo(0, ((_a3 = window.scrollY) != null ? _a3 : window.pageYOffset) + scrollPosition);
...
function useDisposables() {
  let [d] = (0, import_react5.useState)(disposables);
  (0, import_react5.useEffect)(() => () => d.dispose(), [d]);
  return d;
}
...
function useLatestValue(value) {
  let cache = (0, import_react6.useRef)(value);
  useIsoMorphicEffect(() => {
    cache.current = value;
  }, [value]);
  return cache;
...
var useEvent = (
  ...
  function useEvent2(cb) {
    ...
    return import_react7.default.useCallback((...args) => cache.current(...args), [cache]);
  }
);
...
function useIsTouchDevice() {
  var _a3;
  let [mq] = (0, import_react8.useState)(
    () => typeof window !== "undefined" && typeof window.matchMedia === "function" ? window.matchMedia("(pointer: coarse)") : null
  );
  let [isTouchDevice, setIsTouchDevice] = (0, import_react8.useState)((_a3 = mq == null ? void 0 : mq.matches) != null ? _a3 : false);
  useIsoMorphicEffect(() => {
    if (!mq)
      return;
...
function useOwnerDocument(...args) {
  return (0, import_react9.useMemo)(() => getOwnerDocument(...args), [...args]);
}
...
function useActivePress() {
  let target = (0, import_react10.useRef)(null);
  let [pressed, setPressed] = (0, import_react10.useState)(false);
  let [shouldScrollLock, setShouldScrollLock] = (0, import_react10.useState)(false);
  ...
  let handlePointerDown = useEvent((event) => {
    ...
    setPressed(true);
    {
      let owner2 = getOwnerDocument(event.currentTarget);
      d.addEventListener(owner2, "pointerup", reset, false);
      d.addEventListener(
        owner2,
        "pointermove",
        (event2) => {
      ...
      d.addEventListener(owner2, "pointercancel", reset, false);
    }
  });
  ...
  return {
    ...
    pressProps: {
      ...
      onTouchMove: isTouchDevice ? handleTouchMove : void 0,
      onClick: reset
    }
  };
}
...
function ButtonFn(props, ref) {
  ...
  let { isHovered: hover, hoverProps } = $6179b936705e76d3$export$ae780daf29e6d456({
    isDisabled: disabled
  });
...
function useIsHydratingInReact18() {
  ...
  if (!("useSyncExternalStore" in React5)) {
    return false;
  }
  const useSyncExternalStore4 = ((r) => r.useSyncExternalStore)(React5);
...
function useServerHandoffComplete() {
  ...
  let [complete, setComplete] = React5.useState(env.isHandoffComplete);
...
// ../../node_modules/@tanstack/react-virtual/build/lib/index.mjs
var useIsomorphicLayoutEffect = typeof document !== "undefined" ? React12.useLayoutEffect : React12.useEffect;
...
function useResolveButtonType(props, ref) {
  let [type, setType] = (0, import_react26.useState)(() => resolveType(props));
  useIsoMorphicEffect(() => {
...
function useTrackedPointer() {
  let lastPos = (0, import_react27.useRef)([-1, -1]);
  return {
    wasMoved(evt) {
      if (false) {
        return true;
...
function useTreeWalker({
  ...
  let acceptRef = (0, import_react28.useRef)(accept);
  let walkRef = (0, import_react28.useRef)(walk);
...
function useWatch(cb, dependencies) {
  let track = (0, import_react29.useRef)([]);
...
var useInsertionEffect = React14[/* @__PURE__ */ "useInsertionEffect".toString()];
...
function useFloatingId() {
  const [id, setId] = React14.useState(() => serverHandoffComplete ? genId() : void 0);
  index2(() => {
    if (id == null) {
      setId(genId());
    }
...
var useReactId = React14[/* @__PURE__ */ "useId".toString()];
...
var useFloatingParentNodeId = () => {
  ...
  return ((_React$useContext = React14.useContext(FloatingNodeContext)) == null ? void 0 : _React$useContext.id) || null;
};
...
function useFloating2(options) {
  ...
  const onOpenChange = useEffectEvent((open2, event, reason) => {
    ...
    unstable_onOpenChange == null ? void 0 : unstable_onOpenChange(open2, event, reason);
  });
  const domReferenceRef = React14.useRef(null);
  const dataRef = React14.useRef({});
  const events = React14.useState(() => createPubSub())[0];
  const floatingId = useId3();
  const setPositionReference = React14.useCallback((node) => {
...
function useInteractions(propsList) {
  ...
  const getReferenceProps = React14.useCallback(
    (userProps) => mergeProps2(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    deps
  );
  const getFloatingProps = React14.useCallback(
    (userProps) => mergeProps2(userProps, propsList, "floating"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    deps
  );
  const getItemProps = React14.useCallback(
...
function useInnerOffset(context, props) {
  ...
  const controlledScrollingRef = React14.useRef(false);
  const prevScrollTopRef = React14.useRef(null);
  const initialOverflowRef = React14.useRef(null);
  React14.useEffect(() => {
    if (!enabled) {
      return;
    }
...
var FloatingContext = (0, import_react33.createContext)({
  styles: void 0,
  setReference: () => {
  },
  setFloating: () => {
...
var PlacementContext = (0, import_react33.createContext)(
  null
);
PlacementContext.displayName = "PlacementContext";
function useFloatingReference() {
  return (0, import_react33.useContext)(FloatingContext).setReference;
}
function useFloatingReferenceProps() {
  return (0, import_react33.useContext)(FloatingContext).getReferenceProps;
}
function useFloatingPanelProps() {
  let { getFloatingProps, slot } = (0, import_react33.useContext)(FloatingContext);
...
function useFloatingPanel(placement) {
  let updatePlacementConfig = (0, import_react33.useContext)(PlacementContext);
  let stablePlacement = (0, import_react33.useMemo)(
    () => placement,
    [
      JSON.stringify(
        placement,
  ...
  let context = (0, import_react33.useContext)(FloatingContext);
...
function FloatingProvider({
  ...
  let [config, setConfig] = (0, import_react33.useState)(null);
  let [innerOffset, setInnerOffset] = (0, import_react33.useState)(0);
  let overflowRef = (0, import_react33.useRef)(null);
  let [floatingEl, setFloatingElement] = (0, import_react33.useState)(null);
  ...
  if (to === "selection")
    exposedTo = "selection";
  let data = (0, import_react33.useMemo)(
    () => ({
  ...
  return /* @__PURE__ */ React15.createElement(PlacementContext.Provider, { value: setConfig }, /* @__PURE__ */ React15.createElement(
...
function useResolvePxValue(input, element, defaultValue = void 0) {
  ...
  let immediateValue = (0, import_react33.useMemo)(() => computeValue(input, element)[0], [input, element]);
  let [value = immediateValue, setValue] = (0, import_react33.useState)();
  useIsoMorphicEffect(() => {
...
var Context = (0, import_react34.createContext)(null);
Context.displayName = "OpenClosedContext";
function useOpenClosed() {
  return (0, import_react34.useContext)(Context);
}
function OpenClosedProvider({ value, children }) {
  return /* @__PURE__ */ import_react34.default.createElement(Context.Provider, { value }, children);
}
...
var ComboboxActionsContext = (0, import_react35.createContext)(null);
ComboboxActionsContext.displayName = "ComboboxActionsContext";
function useActions(component) {
  let context = (0, import_react35.useContext)(ComboboxActionsContext);
  if (context === null) {
...
var VirtualContext = (0, import_react35.createContext)(null);
function VirtualProvider(props) {
  var _a3;
  let data = useData("VirtualProvider");
  let [paddingStart, paddingEnd] = (0, import_react35.useMemo)(() => {
  ...
  let [baseKey, setBaseKey] = (0, import_react35.useState)(0);
  useIsoMorphicEffect(() => {
    setBaseKey((v) => v + 1);
  }, [(_a3 = data.virtual) == null ? void 0 : _a3.options]);
  return /* @__PURE__ */ import_react35.default.createElement(VirtualContext.Provider, { value: virtualizer }, /* @__PURE__ */ import_react35.default.createElement(
    "div",
    {
      style: {
        position: "relative",
    ...
    virtualizer.getVirtualItems().map((item) => {
      var _a4;
      return /* @__PURE__ */ import_react35.default.createElement(import_react35.Fragment, { key: item.key }, import_react35.default.cloneElement(
...
var ComboboxDataContext = (0, import_react35.createContext)(null);
ComboboxDataContext.displayName = "ComboboxDataContext";
function useData(component) {
  let context = (0, import_react35.useContext)(ComboboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Combobox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_COMBOBOX_TAG = import_react35.Fragment;
function ComboboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react35.useReducer)(stateReducer, {
  ...
  let defaultToFirstOption = (0, import_react35.useRef)(false);
  let optionsPropsRef = (0, import_react35.useRef)({ static: false, hold: false });
  let inputRef = (0, import_react35.useRef)(null);
  ...
  let reset = (0, import_react35.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react35.default.createElement(
    ...
    /* @__PURE__ */ import_react35.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react35.default.createElement(ComboboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react35.default.createElement(ComboboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react35.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && /* @__PURE__ */ import_react35.default.createElement(
        FormFields,
        {
...
function InputFn(props, ref) {
  ...
  let isTyping = (0, import_react35.useRef)(false);
  let d = useDisposables();
  let clear = useEvent(() => {
  ...
  let isComposing = (0, import_react35.useRef)(false);
  ...
  let { isHovered: hover, hoverProps } = $6179b936705e76d3$export$ae780daf29e6d456({
    isDisabled: (_b = data.disabled) != null ? _b : false
  });
  let slot = (0, import_react35.useMemo)(
    () => {
      var _a4;
...
function OptionsFn(props, ref) {
  ...
  if (data.virtual && data.comboboxState === 0 /* Open */) {
    Object.assign(theirProps, {
      ...
      children: /* @__PURE__ */ import_react35.default.createElement(VirtualProvider, null, theirProps.children)
    });
  }
  return render({
    ourProps,
...
function OptionFn(props, ref) {
  ...
  let virtualizer = (0, import_react35.useContext)(VirtualContext);
  ...
  let enableScrollIntoView = (0, import_react35.useRef)(data.virtual || data.__demoMode ? false : true);
  useIsoMorphicEffect(() => {
    if (!data.virtual)
      return;
    if (!data.__demoMode)
...
var DEFAULT_DATA_INTERACTIVE_TAG = import_react36.Fragment;
...
function useRootContainers({
  ...
  var _a3;
  let mainTreeNodeRef = (0, import_react38.useRef)((_a3 = _mainTreeNodeRef == null ? void 0 : _mainTreeNodeRef.current) != null ? _a3 : null);
  ...
  return {
    ...
    mainTreeNodeRef,
    MainTreeNode: (0, import_react38.useMemo)(() => {
      return function MainTreeNode() {
        if (_mainTreeNodeRef != null)
          return null;
        return /* @__PURE__ */ import_react38.default.createElement(Hidden, { features: 4 /* Hidden */, ref: mainTreeNodeRef });
      };
    }, [mainTreeNodeRef, _mainTreeNodeRef])
  };
}
function useMainTreeNode() {
  let mainTreeNodeRef = (0, import_react38.useRef)(null);
  return {
    mainTreeNodeRef,
    MainTreeNode: (0, import_react38.useMemo)(() => {
      return function MainTreeNode() {
...
var ForcePortalRootContext = (0, import_react39.createContext)(false);
function usePortalRoot() {
  return (0, import_react39.useContext)(ForcePortalRootContext);
}
function ForcePortalRoot(props) {
  return /* @__PURE__ */ import_react39.default.createElement(ForcePortalRootContext.Provider, { value: props.force }, props.children);
}

// src/internal/stack-context.tsx
var import_react40 = __toESM(require("react"), 1);
var StackContext = (0, import_react40.createContext)(() => {
});
StackContext.displayName = "StackContext";
function useStackContext() {
  return (0, import_react40.useContext)(StackContext);
}
function StackProvider({
  ...
  return /* @__PURE__ */ import_react40.default.createElement(StackContext.Provider, { value: notify }, children);
}
...
function useIsMounted() {
  let mounted = (0, import_react41.useRef)(false);
  useIsoMorphicEffect(() => {
...
function useOnUnmount(cb) {
  ...
  let trulyUnmounted = (0, import_react42.useRef)(false);
...
function useTabDirection() {
  let direction = (0, import_react43.useRef)(0 /* Forwards */);
  useWindowEvent(
    "keydown",
    (event) => {
      if (event.key === "Tab") {
...
function FocusTrapFn(props, ref) {
  ...
  let d = useDisposables();
  let recentlyUsedTabKey = (0, import_react44.useRef)(false);
  let ourProps = {
    ref: focusTrapRef,
    onKeyDown(e) {
      if (e.key == "Tab") {
  ...
  return /* @__PURE__ */ import_react44.default.createElement(import_react44.default.Fragment, null, Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ import_react44.default.createElement(
    Hidden,
    {
      as: "button",
      type: "button",
    ...
    name: "FocusTrap"
  }), Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ import_react44.default.createElement(
    Hidden,
    {
      as: "button",
      type: "button",
...
function useRestoreElement(enabled = true) {
  let localHistory = (0, import_react44.useRef)(history.slice());
  useWatch(
...
function useInitialFocus({
  ...
  let previousActiveElement = (0, import_react44.useRef)(null);
...
function usePortalTarget(ref) {
  ...
  let groupTarget = (0, import_react45.useContext)(PortalGroupContext);
  let ownerDocument = useOwnerDocument(ref);
  let [target, setTarget] = (0, import_react45.useState)(() => {
...
var DEFAULT_PORTAL_TAG = import_react45.Fragment;
function PortalFn(props, ref) {
  let theirProps = props;
  let internalPortalRootRef = (0, import_react45.useRef)(null);
...
var DEFAULT_GROUP_TAG = import_react45.Fragment;
var PortalGroupContext = (0, import_react45.createContext)(null);
function GroupFn(props, ref) {
  let { target, ...theirProps } = props;
  let groupRef = useSyncRefs(ref);
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react45.default.createElement(PortalGroupContext.Provider, { value: target }, render({
    ourProps,
    theirProps,
...
var PortalParentContext = (0, import_react45.createContext)(null);
function useNestedPortals() {
  let parent = (0, import_react45.useContext)(PortalParentContext);
  let portals = (0, import_react45.useRef)([]);
  ...
  let api = (0, import_react45.useMemo)(
  ...
  return [
    ...
    (0, import_react45.useMemo)(() => {
      return function PortalWrapper({ children }) {
        return /* @__PURE__ */ import_react45.default.createElement(PortalParentContext.Provider, { value: api }, children);
      };
    }, [api])
  ];
}
...
var DialogContext = (0, import_react46.createContext)(null);
DialogContext.displayName = "DialogContext";
function useDialogContext(component) {
  let context = (0, import_react46.useContext)(DialogContext);
  if (context === null) {
...
function DialogFn(props, ref) {
  ...
  let [nestedDialogCount, setNestedDialogCount] = (0, import_react46.useState)(0);
  let didWarnOnRole = (0, import_react46.useRef)(false);
  role = function() {
  ...
  let internalDialogRef = (0, import_react46.useRef)(null);
  ...
  let [state, dispatch] = (0, import_react46.useReducer)(stateReducer2, {
    titleId: null,
    descriptionId: null,
    panelRef: (0, import_react46.createRef)()
  });
  ...
  let hasParentDialog = (0, import_react46.useContext)(DialogContext) !== null;
  ...
  let resolveRootOfMainTreeNode = (0, import_react46.useCallback)(() => {
    var _a3, _b;
  ...
  let resolveRootOfParentDialog = (0, import_react46.useCallback)(() => {
    var _a3, _b;
  ...
  let contextBag = (0, import_react46.useMemo)(
    () => [{ dialogState, close, setTitleId }, state],
    [dialogState, state, close, setTitleId]
  );
  let slot = (0, import_react46.useMemo)(
  ...
  return /* @__PURE__ */ import_react46.default.createElement(
    ...
    /* @__PURE__ */ import_react46.default.createElement(ForcePortalRoot, { force: true }, /* @__PURE__ */ import_react46.default.createElement(Portal, null, /* @__PURE__ */ import_react46.default.createElement(DialogContext.Provider, { value: contextBag }, /* @__PURE__ */ import_react46.default.createElement(Portal.Group, { target: internalDialogRef }, /* @__PURE__ */ import_react46.default.createElement(ForcePortalRoot, { force: false }, /* @__PURE__ */ import_react46.default.createElement(DescriptionProvider, { slot, name: "Dialog.Description" }, /* @__PURE__ */ import_react46.default.createElement(PortalWrapper, null, /* @__PURE__ */ import_react46.default.createElement(
      FocusTrap,
      {
        initialFocus,
    ...
    /* @__PURE__ */ import_react46.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react46.default.createElement(MainTreeNode, null))
  );
}
...
function BackdropFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react46.default.createElement(ForcePortalRoot, { force: true }, /* @__PURE__ */ import_react46.default.createElement(Portal, null, render({
    ourProps,
    theirProps,
    slot,
...
var startTransition = (
  ...
  (_a2 = import_react47.default.startTransition) != null ? _a2 : function startTransition2(cb) {
    cb();
  }
);
...
var DisclosureContext = (0, import_react48.createContext)(null);
DisclosureContext.displayName = "DisclosureContext";
function useDisclosureContext(component) {
  let context = (0, import_react48.useContext)(DisclosureContext);
  if (context === null) {
...
var DisclosureAPIContext = (0, import_react48.createContext)(null);
DisclosureAPIContext.displayName = "DisclosureAPIContext";
function useDisclosureAPIContext(component) {
  let context = (0, import_react48.useContext)(DisclosureAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Disclosure /> component.`);
    if (Error.captureStackTrace)
...
var DisclosurePanelContext = (0, import_react48.createContext)(null);
DisclosurePanelContext.displayName = "DisclosurePanelContext";
function useDisclosurePanelContext() {
  return (0, import_react48.useContext)(DisclosurePanelContext);
}
function stateReducer3(state, action) {
  return match(action.type, reducers3, state, action);
}
var DEFAULT_DISCLOSURE_TAG = import_react48.Fragment;
function DisclosureFn(props, ref) {
  let { defaultOpen = false, ...theirProps } = props;
  let internalDisclosureRef = (0, import_react48.useRef)(null);
  let disclosureRef = useSyncRefs(
    ...
    optionalRef(
      ...
      props.as === import_react48.Fragment
    )
  );
  let panelRef = (0, import_react48.useRef)(null);
  let buttonRef = (0, import_react48.useRef)(null);
  let reducerBag = (0, import_react48.useReducer)(stateReducer3, {
  ...
  let api = (0, import_react48.useMemo)(() => ({ close }), [close]);
  ...
  return /* @__PURE__ */ import_react48.default.createElement(DisclosureContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react48.default.createElement(DisclosureAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react48.default.createElement(
    OpenClosedProvider,
    {
...
function ButtonFn3(props, ref) {
  ...
  let internalButtonRef = (0, import_react48.useRef)(null);
  ...
  let { isHovered: hover, hoverProps } = $6179b936705e76d3$export$ae780daf29e6d456({
    isDisabled: (_b = props.disabled) != null ? _b : false
  });
  let { pressed: active, pressProps } = useActivePress();
  let slot = (0, import_react48.useMemo)(
    () => {
...
function PanelFn2(props, ref) {
  ...
  return /* @__PURE__ */ import_react48.default.createElement(DisclosurePanelContext.Provider, { value: state.panelId }, render({
    mergeRefs,
    ourProps,
    theirProps,
    slot,
...
function FieldFn(props, ref) {
  ...
  let providedDisabled = useDisabled();
  let { disabled = providedDisabled || false, ...theirProps } = props;
  let slot = (0, import_react49.useMemo)(() => ({ disabled }), [disabled]);
  let ourProps = {
    ref,
    disabled,
    "aria-disabled": disabled || void 0
  };
  return /* @__PURE__ */ import_react49.default.createElement(DisabledProvider, { value: disabled }, /* @__PURE__ */ import_react49.default.createElement(LabelProvider, { value: labelledby }, /* @__PURE__ */ import_react49.default.createElement(DescriptionProvider, { value: describedBy }, /* @__PURE__ */ import_react49.default.createElement(IdProvider, { id: inputId }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react49.default.createElement(FormFieldsProvider, null, theirProps.children)
    },
    slot,
...
function FieldsetFn(props, ref) {
  ...
  let { disabled = providedDisabled || false, ...theirProps } = props;
  let [labelledBy, LabelProvider] = useLabels();
  let slot = (0, import_react50.useMemo)(() => ({ disabled }), [disabled]);
  let ourProps = {
    ref,
    role: "group",
    "aria-labelledby": labelledBy,
  ...
  return /* @__PURE__ */ import_react50.default.createElement(DisabledProvider, { value: disabled }, /* @__PURE__ */ import_react50.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function InputFn2(props, ref) {
  ...
  let slot = (0, import_react51.useMemo)(
    () => {
      var _a4;
      return {
        disabled,
...
function LegendFn(props, ref) {
  return /* @__PURE__ */ import_react52.default.createElement(Label, { as: "div", ref, ...props });
}
...
function useComputed(cb, dependencies) {
  let [value, setValue] = (0, import_react53.useState)(cb);
...
function useElementSize(ref, unit = false) {
  let [size2, setSize] = (0, import_react54.useState)(() => computeSize(ref.current));
  useIsoMorphicEffect(() => {
...
function useTextValue(element) {
  let cacheKey = (0, import_react55.useRef)("");
  let cacheValue = (0, import_react55.useRef)("");
  return useEvent(() => {
...
function ModalFn(props, ref) {
  ...
  let didWarnOnRole = (0, import_react56.useRef)(false);
  role = function() {
    if (role === "dialog" || role === "alertdialog") {
      return role;
    }
  ...
  let internalModalRef = (0, import_react56.useRef)(null);
  ...
  let resolveRootOfMainTreeNode = (0, import_react56.useCallback)(() => {
    var _a3, _b;
    return (_b = Array.from((_a3 = ownerDocument == null ? void 0 : ownerDocument.querySelectorAll("body > *")) != null ? _a3 : []).find((root) => {
      if (root.id === "headlessui-portal-root")
        return false;
  ...
  let resolveRootOfParentModal = (0, import_react56.useCallback)(() => {
    var _a3, _b;
    return (_b = Array.from((_a3 = ownerDocument == null ? void 0 : ownerDocument.querySelectorAll("[data-headlessui-portal]")) != null ? _a3 : []).find(
      (root) => root.contains(mainTreeNodeRef.current) && root instanceof HTMLElement
    )) != null ? _b : null;
  ...
  return /* @__PURE__ */ import_react56.default.createElement(import_react56.default.Fragment, null, /* @__PURE__ */ import_react56.default.createElement(ForcePortalRoot, { force: true }, /* @__PURE__ */ import_react56.default.createElement(Portal, null, /* @__PURE__ */ import_react56.default.createElement(
    FocusTrap,
    {
      initialFocus,
      containers: resolveRootContainers,
    ...
    /* @__PURE__ */ import_react56.default.createElement(ForcePortalRoot, { force: false }, /* @__PURE__ */ import_react56.default.createElement(PortalWrapper, null, render({
      ourProps,
      theirProps,
      slot,
  ...
  ))), /* @__PURE__ */ import_react56.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react56.default.createElement(MainTreeNode, null)));
}
...
var ListboxActionsContext = (0, import_react57.createContext)(null);
ListboxActionsContext.displayName = "ListboxActionsContext";
function useActions2(component) {
  let context = (0, import_react57.useContext)(ListboxActionsContext);
  if (context === null) {
...
var ListboxDataContext = (0, import_react57.createContext)(null);
ListboxDataContext.displayName = "ListboxDataContext";
function useData2(component) {
  let context = (0, import_react57.useContext)(ListboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Listbox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_LISTBOX_TAG = import_react57.Fragment;
function ListboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react57.useReducer)(stateReducer4, {
    dataRef: (0, import_react57.createRef)(),
  ...
  let optionsPropsRef = (0, import_react57.useRef)({ static: false, hold: false });
  let buttonRef = (0, import_react57.useRef)(null);
  let optionsRef = (0, import_react57.useRef)(null);
  let listRef = (0, import_react57.useRef)(/* @__PURE__ */ new Map());
  let compare = useByComparator(by);
  let isSelected = (0, import_react57.useCallback)(
  ...
  let data = (0, import_react57.useMemo)(
    () => ({
      ...state,
      value,
      disabled,
  ...
  let slot = (0, import_react57.useMemo)(
    () => ({
  ...
  let actions = (0, import_react57.useMemo)(
    () => ({
      onChange,
      registerOption,
      goToOption,
  ...
  let reset = (0, import_react57.useCallback)(() => {
    return theirOnChange == null ? void 0 : theirOnChange(defaultValue);
  }, [
    theirOnChange
    /* Explicitly ignoring `defaultValue` */
  ...
  return /* @__PURE__ */ import_react57.default.createElement(
    ...
    /* @__PURE__ */ import_react57.default.createElement(FloatingProvider, { enabled: data.listboxState === 0 /* Open */ }, /* @__PURE__ */ import_react57.default.createElement(ListboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react57.default.createElement(ListboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react57.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && value != null && /* @__PURE__ */ import_react57.default.createElement(FormFields, { data: { [name]: value }, form, onReset: reset }),
      render({
        ourProps,
        theirProps,
        slot,
...
var SelectedOptionContext = (0, import_react57.createContext)(false);
...
function OptionsFn2(props, ref) {
  ...
  let initialOption = (0, import_react57.useRef)(null);
  ...
  (0, import_react57.useEffect)(() => {
    ...
    if (container === ((_a4 = getOwnerDocument(container)) == null ? void 0 : _a4.activeElement))
      return;
    d.nextFrame(() => container == null ? void 0 : container.focus({ preventScroll: true }));
  ...
  let Wrapper = modal ? Modal : anchor ? Portal : import_react57.Fragment;
  let wrapperProps = modal ? { enabled: data.listboxState === 0 /* Open */ } : {};
  let [frozenValue, setFrozenValue] = (0, import_react57.useState)(data.value);
  ...
  return /* @__PURE__ */ import_react57.default.createElement(Wrapper, { ...wrapperProps }, /* @__PURE__ */ import_react57.default.createElement(
...
function OptionFn2(props, ref) {
  ...
  let usedInSelectedOption = (0, import_react57.useContext)(SelectedOptionContext) === true;
  ...
  let selected = data.isSelected(value);
  let internalOptionRef = (0, import_react57.useRef)(null);
...
var DEFAULT_SELECTED_OPTION_TAG = import_react57.Fragment;
function SelectedFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react57.default.createElement(SelectedOptionContext.Provider, { value: true }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react57.default.createElement(import_react57.default.Fragment, null, placeholder && shouldShowPlaceholder ? placeholder : children)
    },
    slot,
...
function useDidElementMove(element, enabled = true) {
  let elementPosition = (0, import_react58.useRef)({ left: 0, top: 0 });
  useIsoMorphicEffect(() => {
    let el = element.current;
    if (!el)
      return;
...
var MenuContext = (0, import_react59.createContext)(null);
MenuContext.displayName = "MenuContext";
function useMenuContext(component) {
  let context = (0, import_react59.useContext)(MenuContext);
  if (context === null) {
...
var DEFAULT_MENU_TAG = import_react59.Fragment;
function MenuFn(props, ref) {
  let { __demoMode = false, ...theirProps } = props;
  let reducerBag = (0, import_react59.useReducer)(stateReducer5, {
    __demoMode,
    menuState: __demoMode ? 0 /* Open */ : 1 /* Closed */,
    buttonRef: (0, import_react59.createRef)(),
    itemsRef: (0, import_react59.createRef)(),
    items: [],
    searchQuery: "",
    activeItemIndex: null,
    activationTrigger: 1 /* Other */
  ...
  return /* @__PURE__ */ import_react59.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react59.default.createElement(MenuContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react59.default.createElement(
    OpenClosedProvider,
    {
...
function ButtonFn5(props, ref) {
  ...
  let ourProps = mergeProps(
    getFloatingReferenceProps(),
    {
      ...
      "aria-haspopup": "menu",
      "aria-controls": (_c = state.itemsRef.current) == null ? void 0 : _c.id,
...
function ItemsFn(props, ref) {
  ...
  let Wrapper = modal ? Modal : anchor ? Portal : import_react59.Fragment;
  let wrapperProps = modal ? {
    features: 2 /* ScrollLock */,
    enabled: state.menuState === 0 /* Open */
  } : {};
  return /* @__PURE__ */ import_react59.default.createElement(Wrapper, { ...wrapperProps }, render({
    ourProps,
    theirProps,
    slot,
...
var DEFAULT_ITEM_TAG = import_react59.Fragment;
function ItemFn(props, ref) {
  ...
  let internalItemRef = (0, import_react59.useRef)(null);
  ...
  let bag = (0, import_react59.useRef)({
    disabled,
  ...
  return /* @__PURE__ */ import_react59.default.createElement(LabelProvider, null, /* @__PURE__ */ import_react59.default.createElement(DescriptionProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function SectionFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react59.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot: {},
...
function usePopoverContext(component) {
  let context = (0, import_react60.useContext)(PopoverContext);
  if (context === null) {
...
var PopoverAPIContext = (0, import_react60.createContext)(null);
PopoverAPIContext.displayName = "PopoverAPIContext";
function usePopoverAPIContext(component) {
  let context = (0, import_react60.useContext)(PopoverAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Popover /> component.`);
    if (Error.captureStackTrace)
...
var PopoverGroupContext = (0, import_react60.createContext)(null);
PopoverGroupContext.displayName = "PopoverGroupContext";
function usePopoverGroupContext() {
  return (0, import_react60.useContext)(PopoverGroupContext);
}
var PopoverPanelContext = (0, import_react60.createContext)(null);
PopoverPanelContext.displayName = "PopoverPanelContext";
function usePopoverPanelContext() {
  return (0, import_react60.useContext)(PopoverPanelContext);
}
...
function PopoverFn(props, ref) {
  var _a3;
  let { __demoMode = false, ...theirProps } = props;
  let internalPopoverRef = (0, import_react60.useRef)(null);
  ...
  let buttons = (0, import_react60.useRef)([]);
  let reducerBag = (0, import_react60.useReducer)(stateReducer6, {
    __demoMode,
    ...
    panel: null,
    panelId: null,
    beforePanelSentinel: (0, import_react60.createRef)(),
    afterPanelSentinel: (0, import_react60.createRef)()
  });
  let [
  ...
  let isPortalled = (0, import_react60.useMemo)(() => {
    if (!button)
      return false;
    if (!panel)
      return false;
  ...
  let registerBag = (0, import_react60.useMemo)(
    () => ({
  ...
  (0, import_react60.useEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag), [registerPopover, registerBag]);
  let [portals, PortalWrapper] = useNestedPortals();
  ...
  let api = (0, import_react60.useMemo)(
    () => ({ close, isPortalled }),
    [close, isPortalled]
  );
  ...
  return /* @__PURE__ */ import_react60.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react60.default.createElement(PopoverPanelContext.Provider, { value: null }, /* @__PURE__ */ import_react60.default.createElement(PopoverContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react60.default.createElement(PopoverAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react60.default.createElement(
    OpenClosedProvider,
    {
    ...
    /* @__PURE__ */ import_react60.default.createElement(PortalWrapper, null, render({
      ourProps,
      theirProps,
      slot,
      defaultTag: DEFAULT_POPOVER_TAG,
      name: "Popover"
    }), /* @__PURE__ */ import_react60.default.createElement(root.MainTreeNode, null))
  )))));
}
...
function ButtonFn6(props, ref) {
  ...
  let internalButtonRef = (0, import_react60.useRef)(null);
  ...
  let [uniqueIdentifier] = (0, import_react60.useState)(() => Symbol());
  ...
  return /* @__PURE__ */ import_react60.default.createElement(import_react60.default.Fragment, null, render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BUTTON_TAG6,
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ import_react60.default.createElement(
    Hidden,
    {
      id: sentinelId,
      features: 2 /* Focusable */,
...
function PanelFn3(props, ref) {
  ...
  let internalPanelRef = (0, import_react60.useRef)(null);
  let [floatingRef, style] = useFloatingPanel(anchor);
  let getFloatingPanelProps = useFloatingPanelProps();
  if (anchor != null && modal == null) {
    modal = true;
  ...
  return /* @__PURE__ */ import_react60.default.createElement(PopoverPanelContext.Provider, { value: id }, /* @__PURE__ */ import_react60.default.createElement(PopoverAPIContext.Provider, { value: { close, isPortalled } }, /* @__PURE__ */ import_react60.default.createElement(Wrapper, { ...wrapperProps }, visible && isPortalled && /* @__PURE__ */ import_react60.default.createElement(
    Hidden,
    {
    ...
    visible,
    name: "Popover.Panel"
  }), visible && isPortalled && /* @__PURE__ */ import_react60.default.createElement(
    Hidden,
    {
...
function GroupFn2(props, ref) {
  let internalGroupRef = (0, import_react60.useRef)(null);
  let groupRef = useSyncRefs(internalGroupRef, ref);
  let [popovers, setPopovers] = (0, import_react60.useState)([]);
  ...
  let contextBag = (0, import_react60.useMemo)(
    () => ({
      registerPopover,
      unregisterPopover,
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react60.default.createElement(PopoverGroupContext.Provider, { value: contextBag }, render({
    ourProps,
    theirProps,
    slot,
...
var RadioGroupDataContext = (0, import_react61.createContext)(null);
RadioGroupDataContext.displayName = "RadioGroupDataContext";
function useData3(component) {
  let context = (0, import_react61.useContext)(RadioGroupDataContext);
  if (context === null) {
...
var RadioGroupActionsContext = (0, import_react61.createContext)(null);
RadioGroupActionsContext.displayName = "RadioGroupActionsContext";
function useActions3(component) {
  let context = (0, import_react61.useContext)(RadioGroupActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <RadioGroup /> component.`);
    if (Error.captureStackTrace)
...
function RadioGroupFn(props, ref) {
  ...
  let compare = useByComparator(by);
  let [state, dispatch] = (0, import_react61.useReducer)(stateReducer7, { options: [] });
  let options = state.options;
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let internalRadioGroupRef = (0, import_react61.useRef)(null);
  ...
  let firstOption = (0, import_react61.useMemo)(
    () => options.find((option) => {
  ...
  let containsCheckedOption = (0, import_react61.useMemo)(
  ...
  let radioGroupData = (0, import_react61.useMemo)(
    () => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }),
    [value, firstOption, containsCheckedOption, disabled, compare, state]
  );
  let radioGroupActions = (0, import_react61.useMemo)(
  ...
  let slot = (0, import_react61.useMemo)(() => ({ value }), [value]);
  let reset = (0, import_react61.useCallback)(() => {
    return triggerChange(defaultValue);
  }, [
    triggerChange
    /* Explicitly ignoring `defaultValue` */
  ]);
  return /* @__PURE__ */ import_react61.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react61.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, /* @__PURE__ */ import_react61.default.createElement(RadioGroupActionsContext.Provider, { value: radioGroupActions }, /* @__PURE__ */ import_react61.default.createElement(RadioGroupDataContext.Provider, { value: radioGroupData }, name != null && /* @__PURE__ */ import_react61.default.createElement(
    FormFields,
    {
...
function OptionFn3(props, ref) {
  ...
  let internalOptionRef = (0, import_react61.useRef)(null);
  ...
  let { isFocusVisible: focus, focusProps } = $f7dceffc5ad7768b$export$4e328f61c538687f({
    within: true,
    autoFocus: (_b = props.autoFocus) != null ? _b : false
  });
  let { isHovered: hover, hoverProps } = $6179b936705e76d3$export$ae780daf29e6d456({
  ...
  return /* @__PURE__ */ import_react61.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react61.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, render({
    ourProps,
    theirProps,
    slot,
...
function RadioFn(props, ref) {
  ...
  let internalRadioRef = (0, import_react61.useRef)(null);
...
var GroupContext = (0, import_react63.createContext)(null);
GroupContext.displayName = "GroupContext";
var DEFAULT_GROUP_TAG3 = import_react63.Fragment;
function GroupFn3(props) {
  var _a3;
  let [switchElement, setSwitchElement] = (0, import_react63.useState)(null);
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let context = (0, import_react63.useMemo)(
    () => ({ switch: switchElement, setSwitch: setSwitchElement }),
    [switchElement, setSwitchElement]
  );
  let ourProps = {};
  let theirProps = props;
  return /* @__PURE__ */ import_react63.default.createElement(DescriptionProvider, { name: "Switch.Description", value: describedby }, /* @__PURE__ */ import_react63.default.createElement(
    LabelProvider,
    {
      name: "Switch.Label",
      value: labelledby,
    ...
    /* @__PURE__ */ import_react63.default.createElement(GroupContext.Provider, { value: context }, render({
      ourProps,
      theirProps,
      slot: {},
...
function SwitchFn(props, ref) {
  ...
  let groupContext = (0, import_react63.useContext)(GroupContext);
  let internalSwitchRef = (0, import_react63.useRef)(null);
  ...
  let [checked, onChange] = useControllable(controlledChecked, controlledOnChange, defaultChecked);
  let d = useDisposables();
  let [changing, setChanging] = (0, import_react63.useState)(false);
  let toggle = useEvent(() => {
    setChanging(true);
    onChange == null ? void 0 : onChange(!checked);
    d.nextFrame(() => {
  ...
  return /* @__PURE__ */ import_react63.default.createElement(import_react63.default.Fragment, null, name != null && /* @__PURE__ */ import_react63.default.createElement(FormFields, { data: checked ? { [name]: value || "on" } : {}, form, onReset: reset }), render({ ourProps, theirProps, slot, defaultTag: DEFAULT_SWITCH_TAG, name: "Switch" }));
}
...
function FocusSentinel({ onFocus }) {
  let [enabled, setEnabled] = (0, import_react64.useState)(true);
  let mounted = useIsMounted();
  if (!enabled)
    return null;
...
var TabsDataContext = (0, import_react65.createContext)(null);
TabsDataContext.displayName = "TabsDataContext";
function useData4(component) {
  let context = (0, import_react65.useContext)(TabsDataContext);
  if (context === null) {
...
var TabsActionsContext = (0, import_react65.createContext)(null);
TabsActionsContext.displayName = "TabsActionsContext";
function useActions4(component) {
  let context = (0, import_react65.useContext)(TabsActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Tab.Group /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_TABS_TAG = import_react65.Fragment;
function GroupFn4(props, ref) {
  ...
  let [state, dispatch] = (0, import_react65.useReducer)(stateReducer8, {
  ...
  let tabsData = (0, import_react65.useMemo)(
  ...
  let tabsActions = (0, import_react65.useMemo)(() => ({ registerTab, registerPanel, change }), []);
  useIsoMorphicEffect(() => {
  ...
  return /* @__PURE__ */ import_react65.default.createElement(StableCollection, null, /* @__PURE__ */ import_react65.default.createElement(TabsActionsContext.Provider, { value: tabsActions }, /* @__PURE__ */ import_react65.default.createElement(TabsDataContext.Provider, { value: tabsData }, tabsData.tabs.length <= 0 && /* @__PURE__ */ import_react65.default.createElement(
    FocusSentinel,
    {
      onFocus: () => {
        var _a3, _b;
...
function ListFn(props, ref) {
  ...
  let slot = (0, import_react65.useMemo)(() => ({ selectedIndex }), [selectedIndex]);
  let theirProps = props;
  let ourProps = {
    ref: listRef,
    role: "tablist",
...
function TabFn(props, ref) {
  ...
  let internalTabRef = (0, import_react65.useRef)(null);
  ...
  let ready = (0, import_react65.useRef)(false);
  ...
  let ourProps = mergeProps(
    {
      ...
      "aria-controls": (_d = (_c = panels[myIndex]) == null ? void 0 : _c.current) == null ? void 0 : _d.id,
      "aria-selected": selected,
...
function PanelFn4(props, ref) {
  ...
  let internalPanelRef = (0, import_react65.useRef)(null);
  ...
  if (myIndex === -1)
    myIndex = mySSRIndex;
  let selected = myIndex === selectedIndex;
  let slot = (0, import_react65.useMemo)(() => ({ selected }), [selected]);
  let ourProps = {
    ref: panelRef,
    id,
    role: "tabpanel",
  ...
  if (!selected && ((_c = theirProps.unmount) != null ? _c : true) && !((_d = theirProps.static) != null ? _d : false)) {
    return /* @__PURE__ */ import_react65.default.createElement(Hidden, { as: "span", "aria-hidden": "true", ...ourProps });
  }
  return render({
    ourProps,
    theirProps,
...
function TextareaFn(props, ref) {
  ...
  let slot = (0, import_react66.useMemo)(
    () => {
      var _a4;
      return {
        disabled,
...
function useFlags(initialFlags = 0) {
  let [flags, setFlags] = (0, import_react67.useState)(initialFlags);
  let mounted = useIsMounted();
  let addFlag = (0, import_react67.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
  ...
  let hasFlag = (0, import_react67.useCallback)((flag) => Boolean(flags & flag), [flags]);
  let removeFlag = (0, import_react67.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
      setFlags((flags2) => flags2 & ~flag);
  ...
  let toggleFlag = (0, import_react67.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
      setFlags((flags2) => flags2 ^ flag);
...
var TransitionContext = (0, import_react68.createContext)(null);
TransitionContext.displayName = "TransitionContext";
function useTransitionContext() {
  let context = (0, import_react68.useContext)(TransitionContext);
  if (context === null) {
    throw new Error(
...
function useParentNesting() {
  let context = (0, import_react68.useContext)(NestingContext);
  if (context === null) {
    throw new Error(
      "A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />."
    );
...
var NestingContext = (0, import_react68.createContext)(null);
...
function useNesting(done, parent) {
  ...
  let transitionableChildren = (0, import_react68.useRef)([]);
  let mounted = useIsMounted();
  let d = useDisposables();
  ...
  let todos = (0, import_react68.useRef)([]);
  let wait = (0, import_react68.useRef)(Promise.resolve());
  let chains = (0, import_react68.useRef)({
    enter: [],
    leave: [],
    idle: []
  });
...
function useEvents(events) {
  let eventsRef = (0, import_react68.useRef)(ensureEventHooksExist(events));
...
function TransitionChildFn(props, ref) {
  ...
  let container = (0, import_react68.useRef)(null);
  let transitionRef = useSyncRefs(container, ref);
  let strategy = ((_a3 = rest.unmount) != null ? _a3 : true) ? 0 /* Unmount */ : 1 /* Hidden */;
  let { show, appear, initial } = useTransitionContext();
  let [state, setState] = (0, import_react68.useState)(show ? "visible" /* Visible */ : "hidden" /* Hidden */);
  ...
  let isTransitioning = (0, import_react68.useRef)(false);
  useTransition({
    immediate,
    container,
    classes,
  ...
  return /* @__PURE__ */ import_react68.default.createElement(NestingContext.Provider, { value: nesting }, /* @__PURE__ */ import_react68.default.createElement(
    OpenClosedProvider,
    {
      value: match(state, {
...
function TransitionRootFn(props, ref) {
  ...
  let internalTransitionRef = (0, import_react68.useRef)(null);
  ...
  let [initial, setInitial] = (0, import_react68.useState)(true);
  let changes = (0, import_react68.useRef)([show]);
  useIsoMorphicEffect(() => {
    if (initial === false) {
      return;
    }
  ...
  let transitionBag = (0, import_react68.useMemo)(
    () => ({ show, appear, initial }),
    [show, appear, initial]
  );
  useIsoMorphicEffect(() => {
  ...
  return /* @__PURE__ */ import_react68.default.createElement(NestingContext.Provider, { value: nestingBag }, /* @__PURE__ */ import_react68.default.createElement(TransitionContext.Provider, { value: transitionBag }, render({
    ourProps: {
      ...sharedProps,
      as: import_react68.Fragment,
      children: /* @__PURE__ */ import_react68.default.createElement(
    ...
    theirProps: {},
    defaultTag: import_react68.Fragment,
    features: TransitionChildRenderFeatures,
    visible: state === "visible" /* Visible */,
    name: "Transition"
  })));
...
function ChildFn(props, ref) {
  let hasTransitionContext = (0, import_react68.useContext)(TransitionContext) !== null;
  let hasOpenClosedContext = useOpenClosed() !== null;
  return /* @__PURE__ */ import_react68.default.createElement(import_react68.default.Fragment, null, !hasTransitionContext && hasOpenClosedContext ? (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react68.default.createElement(TransitionRoot, { ref, ...props })
  ) : (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react68.default.createElement(InternalTransitionChild, { ref, ...props })
  ));
}
